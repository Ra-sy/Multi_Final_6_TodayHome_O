...
<head>
<meta charset="UTF-8">
<title>오늘의집 | 취미일상</title>
<link rel="stylesheet" href="../resources/css/board_dailylife.css">
...
<script type="text/javascript">
    ...
    function handleSelectChange1() {	//모두보기 선택시 집들이 초기상태로 돌아옴
        ...
        if (selectedValue === 'all') {
            window.location.href = '/topics/dailylife';
        }
    }
